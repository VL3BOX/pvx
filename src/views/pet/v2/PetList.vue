...
<script>
import petTabs from "@/components/pet/v2/tabs";
import petItem from "@/components/pet/v2/item";
import luckyItem from "@/components/pet/v2/lucky";
...
<style lang="less">
@import "~@/assets/css/pet/v2/list.less";
</style>
